...
public class TopListaRegalos extends JFrame {
	...
	public TopListaRegalos(final JFrame frame) {
		...
		JLabel lblninoosbuenos = new JLabel("Top 5 Lista de Regalos");
		lblninoosbuenos.setBounds(46, 27, 219, 15);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				TopListaRegalos.this.dispose();
			}
		});
		btnNewButton.setBounds(284, 236, 117, 25);
		...
		lblNewLabel_1.setIcon(new ImageIcon("/home/ldcoma10/workspace/Diego/src/gc.gif"));
		lblNewLabel_1.setBounds(271, 27, 143, 208);
